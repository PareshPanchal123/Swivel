  ...
  <v-card>
     <v-card-text>
              <v-container grid-list-md>
                <h3 class="text-center">Outbound Quick Entry and Analysis</h3>
                <v-layout justify-center>
                  <v-flex xs12 sm6 md3>                    
                   ...
                   <v-text-field slot="activator" v-model="date" label="Flight Date" readonly></v-text-field>
                  ...
                  <v-flex xs12 sm6 md3>
                   ...
                   <v-text-field slot="activator" v-model="date1" label="To" readonly></v-text-field>
                ...
                <v-layout justify-center>
                  <v-flex xs12 sm6 md3>                    
                    <v-text-field label="Booking"></v-text-field>
                  </v-flex>
                  <v-flex xs12 sm6 md3>
                ...
                <v-layout justify-center>
                  <v-flex xs12 sm6 md3>                    
                    <v-text-field label="Invoice"></v-text-field>
                  </v-flex>
                  <v-flex xs12 sm6 md3>
                  ...
                  <v-flex xs12 sm6 md3>
                    <v-text-field  label="O.Agent"></v-text-field>
                  </v-flex>                  
                </v-layout>
                <v-layout justify-center>
                  <v-flex xs12 sm6 md3>     
                  <v-select :items="Action" label="Action"></v-select>              
                  </v-flex>
                  <v-flex xs12 sm6 md3>
                    <v-text-field  label="Ref.No."></v-text-field>
                  </v-flex>
                  <v-flex xs12 sm6 md3>
                    <v-text-field  label="Dest."></v-text-field>
                  </v-flex>
                  <v-flex xs12 sm6 md3>
                ...
                <v-layout justify-center>
                  ...
                  <v-flex xs12 sm6 md3>
                  <v-select :items="Salesman" label="Salesman"></v-select>
                  </v-flex>                  
                </v-layout>             
              </v-container>
            </v-card-text>  
            ...
            <v-btn round color="primary"><v-icon>add</v-icon>Add</v-btn> 
      </v-card-actions>
    </v-card>
  </v-app>
</template>
<script>
  export default {
    data: () => ({
      ...
      Division: ['AE','BE', 'CE', 'DE', 'FE'],
      Status: ['Normal', 'Highest','Lowest'],
